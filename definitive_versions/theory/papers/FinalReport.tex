...
\newcommand{\reportTitle}{\textcolor{ugent_blue}{Constrained Unrestricted Hartree Fock and Single Excitation Configuration Interaction}} 
...
\begin{document}
    ...
    \input{content/reportFinal/reportFinal.tex}
    \clearpage
