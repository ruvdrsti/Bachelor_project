...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    \begin{tabular}{m{4.5cm} p{13.5cm} }
                     ...
                     & \noindent\LARGE{\textbf{Open Shell systems: CIS with UHF and CUHF references.$^\dag$}}        \\%Article title goes here instead of the text "This is the title"
...
The operators $J_j$ and $K_$ are called the Coulomb and exchange operators respectively.
...
\begin{center}
  \begin{figure}[h]
    \includegraphics[width=\linewidth]{./../notes/figures/h3_uhf.png}
...
spin uncontaminated system, the expectation value over $\hat{S}^$ should be $0.75$. However, in table \ref{tab:spincon} we can clearly see that this is not always the case.
