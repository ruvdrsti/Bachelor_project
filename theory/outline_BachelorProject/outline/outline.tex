...
In UHF the overlap is not diagonal, so the situation is somwhat different. When the alpha and beta orbitals are not the same, the overlap matrix $S$ will not be diagonal. One can not
