...
\newcommand{\reportTitle}{\textcolor{ugent_blue}{\ce{H3} as an Example for Open Shell Systems: CIS with UHF and CUHF references}} 
\newcommand{\reportName}{\textbf{Ruben Van der Stichelen
Promotor: Prof. Dr. Patrick Bultinck 
Co-promotor: Dr. Guillaume Acke 
Supervisor: Drs. Daria Tolstykh }}
\newcommand{\reportSubject}{\emph{}}
...
\begin{document}
    ...
    \input{./content/reportFinal/outline.tex}
    \clearpage
